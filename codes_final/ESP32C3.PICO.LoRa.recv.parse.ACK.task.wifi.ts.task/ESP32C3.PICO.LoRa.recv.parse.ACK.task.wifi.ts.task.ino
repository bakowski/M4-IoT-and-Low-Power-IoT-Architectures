...
SSD1306Wire display(0x3c, 8, 10); // 12, 14
...
#include <SPI.h>               
#include <LoRa.h>
#define SCK     1  // 18   // GPIO18 -- SX127x's SCK
#define MISO    0  //19   // GPIO19 -- SX127x's MISO
#define MOSI    4  //23   // GPIO23 -- SX127x's MOSI
#define SS      5  // 5   // GPIO05 -- SX127x's CS
#define RST     3  //15   // GPIO15 -- SX127x's RESET
#define DI0     2  //25   // GPIO26 -- SX127x's IRQ(Interrupt Request)
#define freq    8685E5   
#define sf 9
#define sb 125E3  
